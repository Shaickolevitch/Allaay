export default function DataDeletionPage() {
  return (
    <main className="max-w-2xl mx-auto px-6 py-12 text-sm leading-relaxed" dir="rtl">
      ...
      <section className="mb-6">
        ...
        <div className="bg-gray-50 rounded-lg p-4">
          ...
          <p className="text-gray-700">
            ...
            עם הנושא "בקשת מחיקת נתונים" וכתובת הדוא"ל של חשבון ה-Facebook שלכם.
      ...
      <section className="mb-6">
        <h2 className="font-semibold text-base mb-2">אילו נתונים נמחקים</h2>
        <p>
          מחיקת חשבון מסירה: פרופיל משתמש, רשימת חברים, המלצות שנכתבו, תמונות שהועלו,
          והיסטוריית פעילות. נתונים אנונימיים ומצטברים (ללא זיהוי אישי) עשויים להישמר.
        </p>
      </section>
    </main>
  );
